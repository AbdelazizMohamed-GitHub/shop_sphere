...
class StaffProductScreen extends StatefulWidget {
  ...
  @override
  State<StaffProductScreen> createState() => _StaffProductScreenState();
}

class _StaffProductScreenState extends State<StaffProductScreen> {
  @override
  void initState() {
    context.read<UsersRepoImpl>().getStaffProducts(staffId: widget.staffId);
    super.initState();
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<MangeUsersCubit, MangeUsersState>(
